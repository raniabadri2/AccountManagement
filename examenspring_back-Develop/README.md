...
```
cd existing_repo
git remote add origin https://gitlab.com/mohamedlajmi/examenspring_back.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/mohamedlajmi/examenspring_back/-/settings/integrations)
